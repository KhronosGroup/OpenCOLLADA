...
namespace COLLADAFW
{
	...
	//------------------------------
	FloatOrDoubleArray::FloatOrDoubleArray( DFI::DataType type ) 
		: mType ( type )
		, mValuesF(FloatArray::OWNER)
		, mValuesD(DoubleArray::OWNER)
	{}
	...
	FloatOrDoubleArray::FloatOrDoubleArray( const FloatOrDoubleArray& pre )
		...
		, mValuesD(DoubleArray::OWNER)
	{
		if ( mType == DFI::DataType::DATA_TYPE_FLOAT )
		{
			pre.mValuesF.cloneArray( mValuesF );
		}
		else if ( mType == DFI::DataType::DATA_TYPE_DOUBLE )
		{
	...
	size_t FloatOrDoubleArray::getValuesCount() const
	{
		...
		if ( mType == DFI::DataType::DATA_TYPE_DOUBLE ) 
		{
