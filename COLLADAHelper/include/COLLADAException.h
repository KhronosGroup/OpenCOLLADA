...
# define COLLADA_EXCEPT(num, desc, src) throw COLLADA::ExceptionFactory::create( \
   COLLADA::ExceptionCodeType<num>(), desc, src, __FILE__, __LINE__ );
#else
# define COLLADA_EXCEPT(num, desc, src) throw COLLADA::ExceptionFactory::create( \
   COLLADA::ExceptionCodeType<num>(), desc, src, "", 0 );
#endif
