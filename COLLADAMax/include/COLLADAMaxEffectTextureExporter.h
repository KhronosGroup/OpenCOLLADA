...
#ifndef __COLLADA_MAX_TEXTURE_EXPORTER_H__
#define __COLLADA_MAX_TEXTURE_EXPORTER_H__
    ...
    */
    ...
    private:
        ...
        */
        ...
        /**
         * The map holds the collada id for the max id.
         */
        StringToStringMap mMaxIdColladaImageId;
    ...
    public:
        ...
        * The map holds the collada id for the max id.
        */
        COLLADAMax::StringToStringMap& getMaxIdColladaImageId () { return mMaxIdColladaImageId; }

                /**
        * A collada id for every max id.
        */
        const String findColladaImageId ( const String& maxImageId );
...
#endif // __COLLADA_MAX_TEXTURE_EXPORTER_H__