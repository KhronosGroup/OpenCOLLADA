...
namespace COLLADAMaya
{
    ...
    //---------------------------------------------------------------
	void LODExporter::exportLODs(SceneElement* sceneElement)
    {
    ...
    // ------------------------------------
	bool LODExporter::exportLOD(const MDagPath& dagPath)
    {
...
//        delete light;
 ...
 //   //---------------------------------------------------------------
	//void LODExporter::exportExtraAttributes(const SceneElement* sceneElement, COLLADASW::Light* light)
 //   {
 ...
 //   // ------------------------------------
	//const String LODExporter::findColladaLightId(const String& mayaLightId)
 //   {
