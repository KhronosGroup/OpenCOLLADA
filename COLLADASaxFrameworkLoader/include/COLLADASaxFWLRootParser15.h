...
namespace COLLADASaxFWL
{
    ...
    */
    ...
    public:
		...
		/** Starts loading a library physics scenes.*/
		virtual bool begin__library_physics_scenes( const COLLADASaxFWL15::library_physics_scenes__AttributeData& attributeData );

		/** Starts loading a library physics models.*/
		virtual bool begin__library_physics_models( const COLLADASaxFWL15::library_physics_models__AttributeData& attributeData );
