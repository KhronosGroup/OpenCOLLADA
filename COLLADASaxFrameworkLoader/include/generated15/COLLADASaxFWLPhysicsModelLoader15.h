...
virtual bool begin__stiffness____targetable_float3_type( const COLLADASaxFWL15::stiffness____targetable_float3_type__AttributeData& attributeData );

virtual bool end__stiffness();

virtual bool data__stiffness( const float value );

virtual bool begin__damping____targetable_float3_type( const COLLADASaxFWL15::damping____targetable_float3_type__AttributeData& attributeData );

virtual bool end__damping();

virtual bool data__damping( const float value );

virtual bool begin__target_value____targetable_float3_type( const COLLADASaxFWL15::target_value____targetable_float3_type__AttributeData& attributeData );
