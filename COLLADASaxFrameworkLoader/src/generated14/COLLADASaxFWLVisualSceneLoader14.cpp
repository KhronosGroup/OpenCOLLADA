...
bool VisualSceneLoader14::begin__node( const COLLADASaxFWL14::node__AttributeData& attributeData )
{
...
bool VisualSceneLoader14::end__node()
{
...
bool VisualSceneLoader14::end__visual_scene()
{
SaxVirtualFunctionTest14(end__visual_scene());
return mLoader->end__visual_scene();
}


bool VisualSceneLoader14::begin__technique( const COLLADASaxFWL14::technique__AttributeData& attributeData )
{
...
bool VisualSceneLoader14::end__technique()
{
