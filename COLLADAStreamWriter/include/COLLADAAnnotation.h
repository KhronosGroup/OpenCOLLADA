...
namespace COLLADA
{
    ...
    Runtime to the application only and are not interpreted by the COLLADA 
    document. 
    Parent elements:
...
//         String mName;
// 
//         /** Consists of a COLLADA type element that contains a 
...
//         {}
        ...
        {
            mAnnoCloser = mSW->openElement ( CSWC::COLLADA_ELEMENT_ANNOTATE );
        ...
        /** Adds a strongly typed annotation remark to the parent object into 
         ...
         @param dataTypeName Consists of a COLLADA type element that contains a 
                    value of that type. Valid type elements are:
                    bool, bool2, bool3, bool4, int, int2, int3, int4, float,
                    float2, float3, float4, float2x2, float3x3, float4x4, string
