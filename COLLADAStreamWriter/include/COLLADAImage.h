...
namespace COLLADA
{
    ...
    */
    ...
    private:
        ...
        COLLADA document contains the digital contents of a JPEG file, then set
    ...
    public:
        ...
        */
        ...
        COLLADA document contains the digital contents of a JPEG file, then set
        this attribute to "JPG". Optional. */
        const COLLADA::String& getFormat () const { return mFormat; }
        void setFormat ( const COLLADA::String &val ) { mFormat = val; }
