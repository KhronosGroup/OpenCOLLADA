...
namespace COLLADA
{
    ...
    namespace OPEN_GL
    {
        ...
        */
        ...
        {
            // "Repeat"
            if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[0] ) )
                return Sampler::WRAP_MODE_WRAP;

            // "Clamp"
            else if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[1] ) )
                return Sampler::WRAP_MODE_CLAMP;

            // "ClampToEdge"
            else if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[2] ) )
                return Sampler::WRAP_MODE_CLAMP;

            // "ClampToBorder"
            else if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[3] ) )
                return Sampler::WRAP_MODE_BORDER;

            // "MirroredRepeat"
            else if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[4] ) )
                return Sampler::WRAP_MODE_CLAMP;

            // "MirrorClamp"
            else if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[5] ) )
                return Sampler::WRAP_MODE_MIRROR;

            // "MirrorClampToEdge"
            else if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[6] ) )
                return Sampler::WRAP_MODE_MIRROR;

            // "MirrorClampToBorder"
            else if ( COLLADA::Utils::equals ( wrapModeOpenGL, WrapModesOpenGL[7] ) )
                return Sampler::WRAP_MODE_MIRROR;
        ...
        {
            // "none"
            if ( COLLADA::Utils::equals ( samplerFilter, FilterOpenGL[0] ) )
                return Sampler::SAMPLER_FILTER_NONE;

            // "nearest"
            else if ( COLLADA::Utils::equals ( samplerFilter, FilterOpenGL[1] ) )
                return Sampler::SAMPLER_FILTER_NEAREST;

            // "linear"
            else if ( COLLADA::Utils::equals ( samplerFilter, FilterOpenGL[2] ) )
                return Sampler::SAMPLER_FILTER_LINEAR;

            // "nearestmipmapnearest"
            else if ( COLLADA::Utils::equals ( samplerFilter, FilterOpenGL[3] ) )
                return Sampler::SAMPLER_FILTER_NEAREST_MIPMAP_NEAREST;

            // "linearmipmapnearest"
            else if ( COLLADA::Utils::equals ( samplerFilter, FilterOpenGL[4] ) )
                return Sampler::SAMPLER_FILTER_LINEAR_MIPMAP_NEAREST;

            // "nearestmipmaplinear"
            else if ( COLLADA::Utils::equals ( samplerFilter, FilterOpenGL[5] ) )
                return Sampler::SAMPLER_FILTER_NEAREST_MIPMAP_LINEAR;

            // "linearmipmaplinear"
            else if ( COLLADA::Utils::equals ( samplerFilter, FilterOpenGL[6] ) )
