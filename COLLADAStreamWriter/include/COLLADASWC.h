...
namespace COLLADA
{
    ...
    public:
        ...
        static const String COLLADA_FX_SHADER_STAGE_VERTEX;
        static const String COLLADA_FX_SHADER_STAGE_VERTEXPROGRAM;
        static const String COLLADA_FX_SHADER_STAGE_FRAGMENT;
        static const String COLLADA_FX_SHADER_STAGE_FRAGMENTPROGRAM;

        static const String COLLADA_FX_STATE_ALPHA_FUNC;
        static const String COLLADA_FX_STATE_BLEND_FUNC;
        static const String COLLADA_FX_STATE_BLEND_FUNC_SEPARATE;
        static const String COLLADA_FX_STATE_BLEND_EQUATION;
        static const String COLLADA_FX_STATE_BLEND_EQUATION_SEPARATE;
        static const String COLLADA_FX_STATE_COLOR_MATERIAL;
        static const String COLLADA_FX_STATE_CULL_FACE;
        static const String COLLADA_FX_STATE_DEPTH_FUNC;
        static const String COLLADA_FX_STATE_FOG_MODE;
        static const String COLLADA_FX_STATE_FOG_COORD_SRC;
        static const String COLLADA_FX_STATE_FRONT_FACE;
        static const String COLLADA_FX_STATE_LIGHT_MODEL_COLOR_CONTROL;
        static const String COLLADA_FX_STATE_LOGIC_OP;
        static const String COLLADA_FX_STATE_POLYGON_MODE;
        static const String COLLADA_FX_STATE_SHADE_MODEL;
        static const String COLLADA_FX_STATE_STENCIL_FUNC;
        static const String COLLADA_FX_STATE_STENCIL_OP;
        static const String COLLADA_FX_STATE_STENCIL_FUNC_SEPARATE;
        static const String COLLADA_FX_STATE_STENCIL_OP_SEPARATE;
        static const String COLLADA_FX_STATE_STENCIL_MASK_SEPARATE;
        static const String COLLADA_FX_STATE_LIGHT_ENABLE;
        static const String COLLADA_FX_STATE_LIGHT_AMBIENT;
        static const String COLLADA_FX_STATE_LIGHT_DIFFUSE;
        static const String COLLADA_FX_STATE_LIGHT_SPECULAR;
        static const String COLLADA_FX_STATE_LIGHT_POSITION;
        static const String COLLADA_FX_STATE_LIGHT_CONSTANT_ATTENUATION;
        static const String COLLADA_FX_STATE_LIGHT_LINEAR_ATTENUATION;
        static const String COLLADA_FX_STATE_LIGHT_QUADRATIC_ATTENUATION;
        static const String COLLADA_FX_STATE_LIGHT_SPOT_CUTOFF;
        static const String COLLADA_FX_STATE_LIGHT_SPOT_DIRECTION;
        static const String COLLADA_FX_STATE_LIGHT_SPOT_EXPONENT;
        static const String COLLADA_FX_STATE_TEXTURE1D;
        static const String COLLADA_FX_STATE_TEXTURE2D;
        static const String COLLADA_FX_STATE_TEXTURE3D;
        static const String COLLADA_FX_STATE_TEXTURECUBE;
        static const String COLLADA_FX_STATE_TEXTURERECT;
        static const String COLLADA_FX_STATE_TEXTUREDEPTH;
        static const String COLLADA_FX_STATE_TEXTURE1D_ENABLE;
        static const String COLLADA_FX_STATE_TEXTURE2D_ENABLE;
        static const String COLLADA_FX_STATE_TEXTURE3D_ENABLE;
        static const String COLLADA_FX_STATE_TEXTURECUBE_ENABLE;
        static const String COLLADA_FX_STATE_TEXTURERECT_ENABLE;
        static const String COLLADA_FX_STATE_TEXTUREDEPTH_ENABLE;
        static const String COLLADA_FX_STATE_TEXTURE_ENV_COLOR;
        static const String COLLADA_FX_STATE_TEXTURE_ENV_MODE;
        static const String COLLADA_FX_STATE_CLIP_PLANE;
        static const String COLLADA_FX_STATE_CLIP_PLANE_ENABLE;
        static const String COLLADA_FX_STATE_BLEND_COLOR;
        static const String COLLADA_FX_STATE_CLEAR_COLOR;
        static const String COLLADA_FX_STATE_CLEAR_STENCIL;
        static const String COLLADA_FX_STATE_CLEAR_DEPTH;
        static const String COLLADA_FX_STATE_COLOR_MASK;
        static const String COLLADA_FX_STATE_DEPTH_BOUNDS;
        static const String COLLADA_FX_STATE_DEPTH_MASK;
        static const String COLLADA_FX_STATE_DEPTH_RANGE;
        static const String COLLADA_FX_STATE_FOG_DENSITY;
        static const String COLLADA_FX_STATE_FOG_START;
        static const String COLLADA_FX_STATE_FOG_END;
        static const String COLLADA_FX_STATE_FOG_COLOR;
        static const String COLLADA_FX_STATE_LIGHT_MODEL_AMBIENT;
        static const String COLLADA_FX_STATE_LIGHTING_ENABLE;
        static const String COLLADA_FX_STATE_LINE_STIPPLE;
        static const String COLLADA_FX_STATE_LINE_STIPPLE_ENABLE;
        static const String COLLADA_FX_STATE_LINE_WIDTH;
        static const String COLLADA_FX_STATE_MATERIAL_AMBIENT;
        static const String COLLADA_FX_STATE_MATERIAL_DIFFUSE;
        static const String COLLADA_FX_STATE_MATERIAL_EMISSION;
        static const String COLLADA_FX_STATE_MATERIAL_SHININESS;
        static const String COLLADA_FX_STATE_MATERIAL_SPECULAR;
        static const String COLLADA_FX_STATE_MODEL_VIEW_MATRIX;
        static const String COLLADA_FX_STATE_POINT_DISTANCE_ATTENUATION;
        static const String COLLADA_FX_STATE_POINT_FADE_THRESHOLD_SIZE;
        static const String COLLADA_FX_STATE_POINT_SIZE;
        static const String COLLADA_FX_STATE_POINT_SIZE_MIN;
        static const String COLLADA_FX_STATE_POINT_SIZE_MAX;
        static const String COLLADA_FX_STATE_POLYGON_OFFSET;
        static const String COLLADA_FX_STATE_PROJECTION_MATRIX;
        static const String COLLADA_FX_STATE_SCISSOR;
        static const String COLLADA_FX_STATE_STENCIL_MASK;
        static const String COLLADA_FX_STATE_ALPHA_TEST_ENABLE;
        static const String COLLADA_FX_STATE_AUTO_NORMAL_ENABLE;
        static const String COLLADA_FX_STATE_BLEND_ENABLE;
        static const String COLLADA_FX_STATE_COLOR_LOGIC_OP_ENABLE;
        static const String COLLADA_FX_STATE_COLOR_MATERIAL_ENABLE;
        static const String COLLADA_FX_STATE_CULL_FACE_ENABLE;
        static const String COLLADA_FX_STATE_DEPTH_BOUNDS_ENABLE;
        static const String COLLADA_FX_STATE_DEPTH_CLAMP_ENABLE;
        static const String COLLADA_FX_STATE_DEPTH_TEST_ENABLE;
        static const String COLLADA_FX_STATE_DITHER_ENABLE;
        static const String COLLADA_FX_STATE_FOG_ENABLE;
        static const String COLLADA_FX_STATE_LIGHT_MODEL_LOCAL_VIEWER_ENABLE;
        static const String COLLADA_FX_STATE_LIGHT_MODEL_TWO_SIDE_ENABLE;
        static const String COLLADA_FX_STATE_LINE_SMOOTH_ENABLE;
        static const String COLLADA_FX_STATE_LOGIC_OP_ENABLE;
        static const String COLLADA_FX_STATE_MULTISAMPLE_ENABLE;
        static const String COLLADA_FX_STATE_NORMALIZE_ENABLE;
        static const String COLLADA_FX_STATE_POINT_SMOOTH_ENABLE;
        static const String COLLADA_FX_STATE_POLYGON_OFFSET_FILL_ENABLE;
        static const String COLLADA_FX_STATE_POLYGON_OFFSET_LINE_ENABLE;
        static const String COLLADA_FX_STATE_POLYGON_OFFSET_POINT_ENABLE;
        static const String COLLADA_FX_STATE_POLYGON_SMOOTH_ENABLE;
        static const String COLLADA_FX_STATE_POLYGON_STIPPLE_ENABLE;
        static const String COLLADA_FX_STATE_RESCALE_NORMAL_ENABLE;
        static const String COLLADA_FX_STATE_SAMPLE_ALPHA_TO_COVERAGE_ENABLE;
        static const String COLLADA_FX_STATE_SAMPLE_ALPHA_TO_ONE_ENABLE;
        static const String COLLADA_FX_STATE_SAMPLE_COVERAGE_ENABLE;
        static const String COLLADA_FX_STATE_SCISSOR_TEST_ENABLE;
        static const String COLLADA_FX_STATE_STENCIL_TEST_ENABLE;
