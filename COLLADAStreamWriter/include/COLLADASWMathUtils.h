...
namespace COLLADASW
{
    ...
    public:
        ...
        static const double COLLADASW_PI;
        static const float COLLADASW_PI_f;
        /*
        static const double PIff;
        static const double TWOPI;
        static const double HALFPI;
        */
        static const double COLLADASW_DEG_TO_RAD;
        static const double COLLADASW_RAD_TO_DEG;
...
*/
        ...
        {
            return value * COLLADASW_RAD_TO_DEG;
        }

        template<class T>
        static double degToRad ( const T & value )
        {
            return value * COLLADASW_DEG_TO_RAD;
        }
