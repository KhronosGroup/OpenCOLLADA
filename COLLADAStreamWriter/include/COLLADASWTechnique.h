...
namespace COLLADASW
{
    ...
    public:
		...
		void addParameter(const String &paramName, const String &value = "", const String &sid = "", const String &type = "");

        /** Adds a parameter to the technique */
		void addParameter(const String &paramName, const int &value, const String &sid = "", const String &type = "");

        /** Adds a parameter to the technique */
		void addParameter(const String &paramName, const double &value, const String &sid = "", const String &type = "");

        /** Adds a parameter to the technique */
		void addParameter(const String &paramName, const float &value, const String &sid = "", const String &type = "");

        /** Adds a parameter to the technique */
		void addParameter(const String &paramName, const bool &value, const String &sid = "", const String &type = "");
