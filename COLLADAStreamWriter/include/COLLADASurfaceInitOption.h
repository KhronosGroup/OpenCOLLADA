...
namespace COLLADA
{
    ...
    public:
        ...
        animated GIF, or openEXR. In COLLADA, all 3D images are considered to 
        be compound images, because the schema considers them to be an array 
        of slices. Also in COLLADA, 1D images are also planar images, with y 
    ...
    public:
        ...
        /** Returns a reference to the COLLADA name of the face. */
