...
#if 0
    //---------------------------------------------------------------
    String LibraryAnimations::getSuffixBySemantic ( Semantics type )
    {
        String suffix;
        ...
        case ( COLLADA::POSITION ) :
            suffix = LibraryAnimations::POSITIONS_SOURCE_ID_SUFFIX;
            break;

        case ( COLLADA::VERTEX ) :
            suffix = LibraryAnimations::VERTICES_ID_SUFFIX;
            break;

        case ( COLLADA::NORMAL ) :
            suffix = LibraryAnimations::NORMALS_SOURCE_ID_SUFFIX;
            break;

        case ( COLLADA::TEXCOORD ) :
            suffix = LibraryAnimations::TEXTURE_CHANNEL_SOURCE_ID_SUFFIX;
            break;

        case ( COLLADA::GEOTANGENT ) :
            suffix = LibraryAnimations::GEOTANGENT_ID_SUFFIX;
            break;

        case ( COLLADA::GEOBINORMAL ) :
            suffix = LibraryAnimations::GEOBINORMAL_ID_SUFFIX;
            break;
