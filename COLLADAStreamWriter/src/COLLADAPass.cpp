...
namespace COLLADA
{
    ...
    {
        mPassCloser = mSW->openElement ( CSWC::COLLADA_ELEMENT_PASS );
        if ( !sid.empty() )
    ...
    {
        mSW->openElement ( CSWC::COLLADA_ELEMENT_COLOR_TARGET );
        if ( index > -1 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_INDEX, index );
        if ( slice > -1 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_SLICE, slice );
        if ( mip > -1 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_MIP, mip );
        if ( face != SurfaceInitOption::POSITIVE_X )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_FACE, SurfaceInitOption::getFaceString ( face ) );
    ...
    {
        mSW->openElement ( CSWC::COLLADA_ELEMENT_DEPTH_TARGET );
        if ( index > -1 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_INDEX, index );
        if ( slice > -1 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_SLICE, slice );
    ...
    {
        mSW->openElement ( CSWC::COLLADA_ELEMENT_STENCIL_TARGET );
        if ( index > -1 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_INDEX, index );
        if ( slice > -1 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_SLICE, slice );
    ...
    {
        mSW->openElement ( CSWC::COLLADA_ELEMENT_COLOR_CLEAR );
        if ( index > 0 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_INDEX, index );
        mSW->appendValues ( val );
        mSW->closeElement ();
    ...
    {
        mSW->openElement ( CSWC::COLLADA_ELEMENT_DEPTH_CLEAR );
        if ( index > 0 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_INDEX, index );
        mSW->appendValues ( val );
    }
    ...
    {
        mSW->openElement ( CSWC::COLLADA_ELEMENT_STENCIL_CLEAR );
        if ( index > 0 )
            mSW->appendAttribute ( CSWC::COLLADA_ATTRIBUTE_INDEX, index );
        mSW->appendValues ( val );
    }
    ...
    {
        mSW->appendTextElement ( CSWC::COLLADA_ELEMENT_DRAW, draw );
    }
}