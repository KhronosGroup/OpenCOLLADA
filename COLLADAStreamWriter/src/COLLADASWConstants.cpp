...
namespace COLLADASW
{
    ...
    const String CSWC::CSW_FX_BLEND_FUNCTION_ZERO = "ZERO";
    const String CSWC::CSW_FX_BLEND_FUNCTION_ONE = "ONE";
    const String CSWC::CSW_FX_BLEND_FUNCTION_SRC_COLOR = "SRC_COLOR";
    const String CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_SRC_COLOR = "ONE_MINUS_SRC_COLOR";
    const String CSWC::CSW_FX_BLEND_FUNCTION_DEST_COLOR = "DEST_COLOR";
    const String CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_DST_COLOR = "ONE_MINUS_DST_COLOR";
    const String CSWC::CSW_FX_BLEND_FUNCTION_SRC_ALPHA = "SRC_ALPHA";
    const String CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_SRC_ALPHA = "ONE_MINUS_SRC_ALPHA";
    const String CSWC::CSW_FX_BLEND_FUNCTION_DST_ALPHA = "DST_ALPHA";
    const String CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_DST_ALPHA = "ONE_MINUS_DST_ALPHA";
    const String CSWC::CSW_FX_BLEND_FUNCTION_CONSTANT_COLOR = "CONSTANT_COLOR";
    const String CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_CONSTANT_COLOR = "ONE_MINUS_CONSTANT_COLOR";
    const String CSWC::CSW_FX_BLEND_FUNCTION_CONSTANT_ALPHA = "CONSTANT_ALPHA";
    const String CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_CONSTANT_ALPHA = "MINUS_CONSTANT_ALPHA";
    const String CSWC::CSW_FX_BLEND_FUNCTION_SRC_ALPHA_SATURATE = "ALPHA_SATURATE";

    const String CSWC::CSW_FX_BLEND_EQUATION_FUNC_ADD = "FUNC_ADD";
    const String CSWC::CSW_FX_BLEND_EQUATION_FUNC_SUBTRACT = "FUNC_SUBTRACT";
    const String CSWC::CSW_FX_BLEND_EQUATION_FUNC_REVERSE_SUBTRACT = "FUNC_REVERSE_SUBTRACT";
    const String CSWC::CSW_FX_BLEND_EQUATION_MIN = "MIN";
    const String CSWC::CSW_FX_BLEND_EQUATION_MAX = "MAX";
