...
public:
	...
	*/
	...
	/*
	Attribute to specify if the append should test for 2 edge
	loops and fail if any are found. SHOULD NOT BE SET OR MODIFIED
	BY THE USER!!
	*/
	void setTest2EdgeLoops(bool tel){if(tel == true) return; fprintf_s(mFile, "setAttr \".tel\" %i;\n", tel);}
	/*Array of new vertices.*/
