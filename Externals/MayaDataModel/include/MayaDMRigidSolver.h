...
public:
	...
	void getAutoSolverTolerances()
	{
		fprintf(mFile,"\"%s.ast\"",mName.c_str());

	}
	void getDisplayVelocity()
	{
		fprintf(mFile,"\"%s.dv\"",mName.c_str());

	}
	void getDisplayCenterOfMass()
	{
		fprintf(mFile,"\"%s.dcom\"",mName.c_str());

	}
	void getDisplayConstraint()
	{
