...
This node implements a tangentConstraint.  Each constraint has a set
        ...
        <p/>The tangentConstraint node can have any number of target inputs.
        ...
        <blockquote>
                <table>
                        <tr>
                                <th>tangentConstraint attribute</th>
                                <th>connected to</th>
                        </tr>
                        <tr>
        ...
        <p/>The tangentConstraint node uses the constraintTranslate,
        ...
        <p/>The additional tangentConstraint inputs tell the constraint node how to
...
protected:
	TangentConstraint(FILE* file,const std::string& name,const std::string& parent,const std::string& nodeType):Constraint(file, name, parent, nodeType) {}
private:
