...
//			writeMaterialBlocks(materialBindings);
	...
	bool MeshWriter::writeVertices(const COLLADABU::Math::Matrix4& worldMatrix)
	{
		...
		if ( mMeshPositions.getType() == COLLADAFW::DoubleFloatOrIntArray::DATA_TYPE_FLOAT )
		{
		...
		else if ( mMeshPositions.getType() == COLLADAFW::DoubleFloatOrIntArray::DATA_TYPE_DOUBLE )
		{
