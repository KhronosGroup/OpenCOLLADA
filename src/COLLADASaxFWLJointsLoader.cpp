...
namespace COLLADASaxFWL
{
	...
	{
		mCurrentJointPrimitive = FW_NEW COLLADAFW::JointPrimitive( getHandlingFilePartLoader()->getUniqueId( COLLADAFW::JointPrimitive::ID()).getObjectId(), jointPrimitiveType );
	...
	{
		mCurrentJoint = FW_NEW COLLADAFW::Joint( getHandlingFilePartLoader()->getUniqueIdFromId( attributeData.id, COLLADAFW::Joint::ID()).getObjectId() );
